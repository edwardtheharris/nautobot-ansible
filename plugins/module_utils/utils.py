...
ALLOWED_QUERY_PARAMS = {
    ...
    "custom_field": {"label"},
    "custom_field_choice": {"value", "custom_field"},
    ...
    "device": {"name"},
    "device_redundancy_group": {"name"},
    "device_type": {"model"},
    "front_port": {"name", "device", "rear_port"},
    "front_port_template": {"name", "device_type", "rear_port_template"},
    "installed_device": {"name"},
    "interface": {"name", "device", "virtual_machine"},
    "interface_template": {"name", "device_type"},
    "inventory_item": {"name", "device"},
    "ip_address": {"address", "namespace", "device", "interfaces", "vm_interfaces"},
    "ip_addresses": {"address", "namespace", "device", "interfaces", "vm_interfaces"},
    "ipaddresses": {"address", "namespace", "device", "interfaces", "vm_interfaces"},
    "ip_address_to_interface": {"ip_address", "interface", "vm_interface"},
    "lag": {"name"},
    "location": {"name", "id", "parent"},
    "location_type": {"name"},
    "manufacturer": {"name"},
    "master": {"name"},
    "namespace": {"name"},
    "nat_inside": {"namespace", "address"},
    "parent_rack_group": {"name"},
    "parent_tenant_group": {"name"},
    "platform": {"name"},
    ...
    "power_panel": {"name", "location"},
    "power_port": {"name", "device"},
    "power_port_template": {"name", "device_type"},
    "prefix": {"prefix", "namespace"},
    "primary_ip4": {"address", "namespace"},
    "primary_ip6": {"address", "namespace"},
    "provider": {"name"},
    "rack": {"name", "location"},
    "rack_group": {"name"},
    "rear_port": {"name", "device"},
    "rear_port_template": {"name", "device_type"},
    "relationship_associations": {"source_id", "destination_id"},
    "rir": {"name"},
    "role": {"name"},
    "route_target": {"name"},
    ...
    "statuses": {"name"},
    "tags": {"name"},
    "tagged_vlans": {"group", "name", "location", "vid", "vlan_group", "tenant"},
    "tenant": {"name"},
    "tenant_group": {"name"},
    "termination_a": {"name", "device", "virtual_machine"},
    "termination_b": {"name", "device", "virtual_machine"},
    "untagged_vlan": {"group", "name", "location", "vid", "vlan_group", "tenant"},
    "virtual_chassis": {"name", "device"},
    "virtual_machine": {"name", "cluster"},
    "vlan": {"name", "location", "tenant", "vid", "vlan_group"},
    "vlan_group": {"name", "location"},
    "vm_interface": {"name", "virtual_machine"},
    "vrf": {"name", "namespace", "rd"},
}

QUERY_PARAMS_IDS = {"circuit", "cluster", "device", "group", "interface", "rir", "vrf", "tenant", "type", "virtual_machine", "vminterface"}
...
REQUIRED_ID_FIND = {
    "cables": {"termination_a_type", "termination_b_type", "type", "length_unit"},
    "console_ports": {"type"},
